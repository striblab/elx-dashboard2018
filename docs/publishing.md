...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/elx-dashboard-2018">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/elx-dashboard-2018/styles.bundle.css`
      * `scripts`: `news/projects/all/elx-dashboard-2018/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/elx-dashboard-2018/",
      "url": "http://static.startribune.com/news/projects-staging/all/elx-dashboard-2018/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/elx-dashboard-2018/",
      "url": "http://static.startribune.com/news/projects/all/elx-dashboard-2018/"
    }
  }
}
```
